...
<div class="mt-6 grid gap-6 lg:grid-cols-3">
    ...
    <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
        ...
        <div class="mt-4 text-xs text-slate-500">
            ...
            <code class="block mt-1 break-words">unique_number, admission_number, name, dob, gender, course, division, house, course_category_group, mobile, email, guardian_name, status, event_instances</code>
