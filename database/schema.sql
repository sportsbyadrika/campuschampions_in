...
CREATE TABLE IF NOT EXISTS `certificate_templates` (
    ...
    `margin_top`    SMALLINT UNSIGNED NOT NULL DEFAULT 95,
    `margin_right`  SMALLINT UNSIGNED NOT NULL DEFAULT 22,
    `margin_bottom` SMALLINT UNSIGNED NOT NULL DEFAULT 80,
    ...
    `date_left`     SMALLINT UNSIGNED NOT NULL DEFAULT 20,
    `date_font_size`    SMALLINT UNSIGNED NOT NULL DEFAULT 11,
    `date_font_color`   VARCHAR(7) NOT NULL DEFAULT '#333333',
    `number_prefix` VARCHAR(30) NOT NULL DEFAULT '',
    `number_suffix` VARCHAR(30) NOT NULL DEFAULT '',
